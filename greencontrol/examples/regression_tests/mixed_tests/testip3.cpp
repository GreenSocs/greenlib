...
void TestIP3::main_action() {
  ...
  // /////////////////////////////////////////////////////////////////////////
  // ///////    unsigned short:   Full Test of all operators    //////////////
  // /////////////////////////////////////////////////////////////////////////
  
  SPACE; SPACE;
  
  unsigned short as = 100;
  ushort_param = as;
  IP3test("'ushort_param = (unsigned short) 100' ushort_param="<<ushort_param);
  
  ushort_param = 320 - ushort_param;
  IP3test("'ushort_param = 320 - ushort_param' : ushort_param="<<ushort_param);
  
  ushort_param += 15;
  IP3test("'ushort_param += 15' : ushort_param="<<ushort_param);
  
  IP3test("ushort_param++="<<ushort_param++);
  IP3test("ushort_param="<<ushort_param);
  ...
  ushort_param += 15;
  IP3test("'uint_param += 15' : ushort_param="<<ushort_param);
  
  ushort_param -= 30;
  IP3test("'ushort_param -= 30' : ushort_param="<<ushort_param);
  
  ushort_param /= 4;
  IP3test("'ushort_param /= 4' : ushort_param="<<ushort_param);
  
  ushort_param *= 3;
  IP3test("'ushort_param *= 3' : ushort_param="<<ushort_param);
  
  ushort_param %= 6;
  IP3test("'ushort_param %= 6' : ushort_param="<<ushort_param);
  
  ushort_param ^= 5;
  IP3test("'ushort_param ^= 5' : ushort_param="<<ushort_param);
  
  ushort_param &= 60;
  IP3test("'ushort_param &= 60' : ushort_param="<<ushort_param);
  
  ushort_param |= 3;
  IP3test("'ushort_param |= 3' : ushort_param="<<ushort_param);
  
  unsigned short us = ushort_param; us <<= 2;
  ushort_param <<= 2;
  IP3test("'ushort_param <<= 2' : ushort_param ("<<us<<") ="<<ushort_param);
  ...
  IP3test("'ushort_param != 7' ");
  if (ushort_param != 7)  
    cout<<"               true" <<endl;
  else
    cout<<"               false"<<endl;
  
  IP3test("'ushort_param != 4' ");
  if (ushort_param != 4)  
    cout<<"               true" <<endl;
  else
    cout<<"               false"<<endl;
  ...
  // /////////////////////////////////////////////////////////////////////////
  // ///////             short:   Full Test of all operators    //////////////
  // /////////////////////////////////////////////////////////////////////////
  ...
  short ass = 100;
  short_param = ass;
  IP3test("'short_param = (short) 100' short_param="<<short_param);
  
  short_param = 20 - short_param;
  IP3test("'short_param = 20 - short_param' : short_param="<<short_param);
  
  short_param += 315;
  IP3test("'short_param += 315' : short_param="<<short_param);
  
  IP3test("short_param++="<<short_param++);
  IP3test("short_param="<<short_param);
  ...
  short_param += 15;
  IP3test("'uint_param += 15' : short_param="<<short_param);
  
  short_param -= 30;
  IP3test("'short_param -= 30' : short_param="<<short_param);
  
  short_param /= 4;
  IP3test("'short_param /= 4' : short_param="<<short_param);
  
  short_param *= 3;
  IP3test("'short_param *= 3' : short_param="<<short_param);
  
  short_param %= 6;
  IP3test("'short_param %= 6' : short_param="<<short_param);
  
  short_param ^= 5;
  IP3test("'short_param ^= 5' : short_param="<<short_param);
  
  short_param &= 60;
  IP3test("'short_param &= 60' : short_param="<<short_param);
  
  short_param |= 3;
  IP3test("'short_param |= 3' : short_param="<<short_param);
  
  short uss = short_param; uss <<= 2;
  short_param <<= 2;
  IP3test("'short_param <<= 2' : short_param ("<<uss<<") ="<<short_param);
  ...
  IP3test("'short_param != 7' ");
  if (short_param != 7)  
    cout<<"               true" <<endl;
  else
    cout<<"               false"<<endl;
  
  IP3test("'short_param != 4' ");
  if (short_param != 4)  
    cout<<"               true" <<endl;
  else
    cout<<"               false"<<endl;
...
*/
  ...
  unsigned long ul = 10;
  gs::gs_param<unsigned long long> ull2_par("ull2_par", ull);
  gs::gs_param<unsigned long long> ull3_par("ull3_par", ul);
  gs::gs_param<unsigned long long> ull4_par("ull4_par", (unsigned long) unsi);
  ...
  gs::gs_param<unsigned long> ul1_par("ul1_par", ul);
  gs::gs_param<unsigned long> ul2_par("ul2_par", 11);
  ...
  gs::cnf::cnf_api_if *mApi = gs::cnf::GCnf_Api::getApiInstance(this);
  ...
  // TODO: choose another one, short is existing as specialization!
  gs::gs_param<short> tmp_short_param("tmp_short_param");
  tmp_short_param = 12;
  short chval;
  success = mApi->getValue<short>(tmp_short_param.getName(), chval);
  assert(success == true);
  IP3test("Api call getValue('"<<tmp_short_param.getName()<<"') = " << chval << "  (should be "<< tmp_short_param <<")");
