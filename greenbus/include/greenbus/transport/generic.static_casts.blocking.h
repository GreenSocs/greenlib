 ...
 */
//---------------------------------------------------------------------------
//#include "generic.static_casts.h"
...
#define BLOCKFRAGMENT2(out)      \
  ...
  phase& block(accessHandle th, phase _p, phase& out, GenericSimulationModeType m=MODE_BA) 
  {
  ...
  phase& block(accessHandle th, phase _p, phase& out, const sc_time &d, GenericSimulationModeType m=MODE_BA) 
  {
    BLOCKFRAGMENT1(th, _p, m);
  ...
  phase& block(accessHandle th, phase _p, phase& out, double d, sc_time_unit u, GenericSimulationModeType m=MODE_BA) 
  {
    BLOCKFRAGMENT1(th, _p, m);
  ...
  phase& block(accessHandle th, phase _p, phase& out, enumPeqDelay d, GenericSimulationModeType m=MODE_BA)
  {
    BLOCKFRAGMENT1(th, _p, m);
    port.out->notify(tc,d);
    BLOCKFRAGMENT2(out);
...
#define BLOCKFRAGMENT3(th, m) \
  ...
  phase& block(accessHandle th, phase& out, GenericSimulationModeType m=MODE_BA) 
  {
    BLOCKFRAGMENT3(th, m);
    port.out->notify(tc);
    BLOCKFRAGMENT2(out);
  ...
  phase& block(accessHandle th, phase& out, const sc_time &d, GenericSimulationModeType m=MODE_BA) 
  {
    BLOCKFRAGMENT3(th, m);
    port.out->notify(tc,d);
    BLOCKFRAGMENT2(out);
  ...
  phase& block(accessHandle th, phase& out, double d, sc_time_unit u, GenericSimulationModeType m=MODE_BA) 
  {
    BLOCKFRAGMENT3(th, m);
    port.out->notify(tc,d,u);
    BLOCKFRAGMENT2(out);
  ...
  phase& block(accessHandle th, phase& out, enumPeqDelay d, GenericSimulationModeType m=MODE_BA)
  {
    BLOCKFRAGMENT3(th, m);
    port.out->notify(tc,d);
    BLOCKFRAGMENT2(out);
...
public:
  ...
  {
    PORT::b_out->b_transact(_getTransactionAccess(t)); 
   ...
   */
  //---------------------------------------------------------------------------
  typedef GenericInitiatorBlockingAPI<master_port<GenericTransaction,GenericMasterAccess,GenericPhase, GenericTransactionCreator> > GenericMasterBlockingPort;
