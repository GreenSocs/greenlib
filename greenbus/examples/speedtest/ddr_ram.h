...
#define DDR_SIZE               0x200000 /* initial memory size 2MB */
...
public:
  ...
  gb_param<MBurstLength> size;
  /// write wait states for this ddr memory
  gb_param<gs_uint32> write_ws;
  /// read wait states for this ddr memory
  gb_param<gs_uint32> read_ws;
