...
#ifndef __PCIeRecvDevice2_h__
#define __PCIeRecvDevice2_h__
...
public:
  ...
  SC_HAS_PROCESS(PCIeRecvDevice2);

  // Constructor
  PCIeRecvDevice2(sc_module_name name_) : 
    sc_module(name_),
    mAPI("Recv_PCIeAPI", this)
  {
    cout<<"Constructor PCIeRecvDevice2 " << name() <<endl;
