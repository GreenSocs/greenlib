...
void PCIeRecvDevice::b_transact(PCIeTransactionHandle th) {
  ...
  switch(cmd) {
    ...
    case CnfgReadTy0:
      {
        PCIeDEBUG("received transaction of type 'CnfgReadTy0':");
    ...
    case CnfgWriteTy0:
      {
        PCIeDEBUG("received transaction of type 'CnfgWriteTy0':");
    ...
    case CnfgReadTy1:
      {
        PCIeDEBUG("received transaction of type 'CnfgReadTy1':");
    ...
    case CnfgWriteTy1:
      {
        PCIeDEBUG("received transaction of type 'CnfgWriteTy1':");
        // only allowed in switches!
        ah->init_Unsupported_Request();
        SC_REPORT_WARNING(name(), "Endpoint not allowed to get Type 1 Configuration Request: Unsupported Request.");
      }
    ...
    case Msg:
      {
        PCIeDEBUG("received transaction of type 'Msg':");
