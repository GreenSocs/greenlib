...
#ifndef __PCIeRoutingTestSendDevice_h__
#define __PCIeRoutingTestSendDevice_h__
...
class PCIeRoutingTestSendDevice
 : public sc_module,
   public PCIe_recv_if
{
public:
...
public:
  ...
  SC_HAS_PROCESS(PCIeRoutingTestSendDevice);

  // Constructor
  PCIeRoutingTestSendDevice(sc_module_name name_) : 
    sc_module(name_),
    mAPI("Ma1_PCIeAPI", NULL)
  {
#ifndef ENABLE_SPEED_CHECK_SCENARIO
    cout<<"Constructor PCIeRoutingTestSendDevice " << name() <<endl;
#endif  
  ...
  void do_MemoryRead(MAddr addr, unsigned int data_size, bool lock);
