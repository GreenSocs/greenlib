...
\sloppy % Verhindert uebervolle H-Boxen (aber größere Spaces!)
\nonfrenchspacing % Abstand nach Satzende immer gleich groß
...
\hypersetup{%
							...
							bookmarksnumbered,
              pdftitle={GreenBus PCI Express User's Guide},
              pdfsubject={User's Guide for the GreenBus PCIe Implementation},
              pdfauthor={Christian Schroeder, Technical University of Braunschweig, Dept. E.I.S. and GreenSocs Ltd},
              pdfkeywords={SystemC GreenSocs GreenBus PCIe PCI Express},
              pdfstartview=FitH
}
\author{Copyright GreenSocs Ltd 2007\\ \\Developed by\\Christian Schroeder and Wolfgang Klingauf\\Technical University of Braunschweig, Dept. E.I.S.}
\title{GreenBus PCI Express User's Guide}
